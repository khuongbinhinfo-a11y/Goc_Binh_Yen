...
type TamLinhDetailClientProps = {
  post: LocalizedContentItem;
};
...
export default function TamLinhDetailClient({ post }: TamLinhDetailClientProps) {
  ...
  const handleShareFacebook = async () => {
    const shareText = [post.title, "", post.content, "", getArticleUrl()].filter(Boolean).join("\n");
