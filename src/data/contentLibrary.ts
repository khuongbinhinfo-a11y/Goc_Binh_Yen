...
const baseSpiritualPosts: ContentItem[] = [
  {
    ...
    audioUrl: "/audio/tam-linh/mua-chuong-chieu-trong-san-chua-nho.m4a",
    hasAudio: true,
    hasVideo: false,
    isFeatured: true,
  },
  ...
  },
  {
    ...
    audioUrl: "/audio/tam-linh/mot-ngay-im-lang-ben-song.m4a",
    hasAudio: true,
    hasVideo: false,
    isFeatured: false,
  },
  {
    ...
    audioUrl: "/audio/tam-linh/hoc-tho-cham-giua-ngay-dai.m4a",
    hasAudio: true,
    hasVideo: true,
...
additionalSpiritualPosts.push({
  ...
  audioUrl: "/audio/tam-linh/mot-sang-quet-la-trong-san-chua.m4a",
  hasAudio: true,
  hasVideo: false,
  isFeatured: false,
});
...
additionalSpiritualPosts.push({
  ...
  audioUrl: "/audio/tam-linh/thap-den-nho-truoc-khi-ngu.m4a",
  hasAudio: true,
  hasVideo: false,
  isFeatured: false,
});
...
additionalSpiritualPosts.push({
  ...
  audioUrl: "/audio/tam-linh/ngoi-yen-nghe-mua-cham-mai-hien.m4a",
  hasAudio: true,
  hasVideo: false,
  isFeatured: false,
});
